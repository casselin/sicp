...
;; Support for compiled procedures
...
;; Compiler environment (lexical addressing)
...
;; So that eceval.rkt can modify the global environment
(define (set-global-env! val)
  (set! the-global-environment val))